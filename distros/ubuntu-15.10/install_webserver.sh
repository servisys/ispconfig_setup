#---------------------------------------------------------------------
# Function: InstallWebServer Ubuntu 15.10
...
InstallWebServer() {
  ...
  if [ "$CFG_WEBSERVER" == "apache" ]; then
	...
	apt_install apache2 apache2-doc apache2-utils libapache2-mod-php5 libapache2-mod-fcgid apache2-suexec-pristine libruby libapache2-mod-python
	...
	apt_install php5 php5-common php5-gd php5-mysql php5-imap php5-cli php5-cgi php-pear php-auth php5-mcrypt php5-imagick php5-curl php5-intl php5-memcache php5-memcached php5-ming php5-ps php5-pspell php5-recode php5-sqlite php5-tidy php5-xmlrpc php5-xsl
	echo -e "[${green}DONE${NC}]\n"
	echo -n "Installing APCu... "
	apt_install php5-apcu
	echo -e "[${green}DONE${NC}]\n"
  ...
  # fi
	...
	apt_install php5-mysql php5-curl php5-gd php5-intl php-pear php5-imagick php5-imap php5-mcrypt php5-memcache php5-ming php5-ps php5-pspell php5-recode php5-sqlite php5-tidy php5-xmlrpc php5-xsl
	echo -e "[${green}DONE${NC}]\n"
	echo -n "Installing APCu... "
	apt_install php5-apcu
