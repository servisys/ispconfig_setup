...
InstallMTA() {
  case $CFG_MTA in
	"courier")
	  ...
	  hide_output service courier-imap-ssl restart
	  hide_output service courier-pop-ssl restart
	  hide_output service courier-authdaemon restart
	  hide_output service saslauthd restart
