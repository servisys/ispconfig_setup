...
InstallphpmyAdmin() {
    ...
    sed -i "$ a\$cfg['Servers'][\$i]['controlhost'] = 'localhost';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['controlport'] = '';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['controluser'] = 'pma';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['controlpass'] = '$CFG_MYSQL_ROOT_PWD';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['pmadb'] = 'phpmyadmin';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['bookmarktable'] = 'pma__bookmark';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['relation'] = 'pma__relation';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['table_info'] = 'pma__table_info';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['table_coords'] = 'pma__table_coords';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['pdf_pages'] = 'pma__pdf_pages';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['column_info'] = 'pma__column_info';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['history'] = 'pma__history';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['table_uiprefs'] = 'pma__table_uiprefs';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['tracking'] = 'pma__tracking';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['userconfig'] = 'pma__userconfig';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['recent'] = 'pma__recent';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['favorite'] = 'pma__favorite';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['users'] = 'pma__users';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['usergroups'] = 'pma__usergroups';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['navigationhiding'] = 'pma__navigationhiding';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['savedsearches'] = 'pma__savedsearches';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['central_columns'] = 'pma__central_columns';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['designer_settings'] = 'pma__designer_settings';" /usr/share/phpmyadmin/config.inc.php
    sed -i "$ a\$cfg['Servers'][\$i]['export_templates'] = 'pma__export_templates';" /usr/share/phpmyadmin/config.inc.php
    echo -e "[${green}DONE${NC}]\n"
}
